...
export default function CoursesPage() {
  ...
  const loadCourses = useCallback(async () => {
    ...
    try {
      ...
      setCourses([]);
      setError(
        requestError?.message || "We could not load the course catalog.",
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <main className="min-h-screen bg-background">
      <section className="border-b bg-gradient-to-b from-blue-50 to-background py-14">
        <div className="container">
          ...
          <h1 className="max-w-3xl text-4xl font-bold tracking-tight md:text-5xl">
            Find the right course for your next goal
          </h1>
          <p className="mt-4 max-w-2xl text-lg text-muted-foreground">
            Search the full catalog and filter by category, level, price,
            rating, or featured status.
          </p>
            ...
            <div className="mt-3 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="ALL_LEVELS">All levels courses</SelectItem>
                </SelectContent>
              </Select>
              <Select
                value={price}
      ...
      {!filtersActive && page === 1 && featuredCourses.length > 0 && (
      ...
      <section className="container py-12">
        ...
        {loading && (
          ...
          >
            {Array.from({ length: 6 }, (_, index) => (
              <div
                key={index}
                className="h-[360px] animate-pulse rounded-xl border bg-muted/50"
              />
            ))}
          </div>
        )}
        {!loading && error && (
          <div className="rounded-xl border border-red-200 bg-red-50 p-10 text-center">
            ...
            <Button onClick={loadCourses} className="mt-5">
              Try again
            </Button>
          </div>
        )}
