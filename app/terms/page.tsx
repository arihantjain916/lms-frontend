                ...
                <Card className="mt-6">
                  <CardContent className="p-4">
                    ...
                    <p className="text-sm text-muted-foreground mb-4">
                      If you have any questions about our terms or policies,
                    ...
                    <div className="prose max-w-none">
                      <TabsContent value="terms">
                        ...
                        <p>
                          ...
                          <Link href="/">https://eduportal.com</Link>, you are
                          ...
                          site. The materials contained in this website are
                        ...
                        <p>
                          ...
                          EduPortal's website for personal, non-commercial
                        ...
                        <ul>
                          ...
                          <li>
                            ...
                            software contained on EduPortal's website;
                          </li>
                          <li>
                        ...
                        <p>
                          ...
                          terminated by EduPortal at any time. Upon terminating
                          your viewing of these materials or upon the
                        ...
                        <h3>3. Disclaimer</h3>
                        <p>
                          The materials on EduPortal's website are provided on
                          an 'as is' basis. EduPortal makes no warranties,
                        ...
                        <p>
                          Further, EduPortal does not warrant or make any
                        ...
                        <h3>4. Limitations</h3>
                        <p>
                          In no event shall EduPortal or its suppliers be liable
                          ...
                          use the materials on EduPortal's website, even if
                          EduPortal or a EduPortal authorized representative has
                          been notified orally or in writing of the possibility
                          of such damage. Because some jurisdictions do not
                        ...
                        <p>
                          The materials appearing on EduPortal's website could
                          include technical, typographical, or photographic
                          errors. EduPortal does not warrant that any of the
                          materials on its website are accurate, complete or
                          current. EduPortal may make changes to the materials
                          contained on its website at any time without notice.
                          However EduPortal does not make any commitment to
                          update the materials.
                        </p>

                        <h3>6. Links</h3>
                        <p>
                          EduPortal has not reviewed all of the sites linked to
                          its website and is not responsible for the contents of
                          any such linked site. The inclusion of any link does
                          not imply endorsement by EduPortal of the site. Use of
                          any such linked website is at the user's own risk.
                        </p>

                        <h3>7. Course Content and Certification</h3>
                        <p>
                          EduPortal provides educational content and
                          certification upon completion of certain courses. The
                          certification provided is not equivalent to accredited
                          degrees or professional certifications unless
                          explicitly stated. EduPortal does not guarantee
                          employment or career advancement as a result of
                          completing courses or obtaining certifications through
                          our platform.
                        </p>
                        <p>
                          Course content is provided for educational purposes
                          only and should not be considered professional advice.
                          Users should consult with appropriate professionals
                          for specific advice relevant to their particular
                          situations.
                        </p>
                        ...
                        <p>
                          ...
                          the Terms, which may result in immediate termination
                        ...
                        <p>
                          ...
                          or actions under your password, whether your password
                      ...
                      <TabsContent value="definitions">
                        ...
                        <p>
                          ...
                          Service, Privacy Statement, and any or all Agreements:
                        </p>

                        <h3>1. Parties</h3>
                        <p>
                          "Client", "You" and "Your" refers to you, the person
                          accessing this website and accepting the Company's
                          terms and conditions. "The Company", "Ourselves",
                          "We", "Our" and "Us", refers to EduPortal. "Party",
                        ...
                        <h3>2. Services</h3>
                        <p>
                          "Services" refers to the educational content, courses,
                          programs, certifications, and related materials
                          provided through the EduPortal platform.
                        </p>

                        <h3>3. Content</h3>
                        <p>
                          "Content" refers to all materials available on the
                          EduPortal platform, including but not limited to
                          course materials, videos, text, images, graphics, user
                          interfaces, visual interfaces, and computer code.
                        </p>

                        <h3>4. User</h3>
                        <p>
                          "User" refers to any individual who accesses or uses
                          the EduPortal platform, whether registered or
                          unregistered.
                        </p>

                        <h3>5. Student</h3>
                        <p>
                          "Student" refers to a registered user who enrolls in
                          courses or programs offered through the EduPortal
                          platform.
                        </p>

                        <h3>6. Instructor</h3>
                        <p>
                          "Instructor" refers to an individual or entity that
                          creates, provides, or facilitates educational content
                          on the EduPortal platform.
                        </p>

                        <h3>7. Subscription</h3>
                        <p>
                          "Subscription" refers to a recurring payment
                          arrangement that provides access to specific content
                          or services on the EduPortal platform for a defined
                          period.
                        </p>

                        <h3>8. Course</h3>
                        <p>
                          "Course" refers to a structured educational offering
                          available on the EduPortal platform, which may include
                          videos, quizzes, assignments, and other learning
                          materials.
                        </p>

                        <h3>9. Program</h3>
                        <p>
                          "Program" refers to a collection of courses or a
                          comprehensive educational offering designed to provide
                          in-depth knowledge or skills in a specific area.
                        </p>

                        <h3>10. Certificate</h3>
                        <p>
                          "Certificate" refers to a digital or physical document
                          issued by EduPortal upon successful completion of a
                          course or program, indicating that the student has met
                      ...
                      <TabsContent value="changes">
                        ...
                        <p>
                          EduPortal reserves the right, at its sole discretion,
                        ...
                        <ul>
                          <li>
                            Sending an email to the email address associated
                            with your account
                          </li>
                          <li>Posting a notice on our website</li>
                          <li>
                            Displaying a notification when you log in to your
                            account
                          </li>
                        </ul>
                        <p>
                        ...
                        <p>
                          Previous versions of our Terms of Service are archived
                          and available upon request. To request access to a
                          previous version, please contact our support team.
                        </p>

                        <h3>Change Log</h3>
                        <p>
                          Below is a summary of significant changes to our Terms
                          of Service:
                        </p>
                        <ul>
                          <li>
                            <strong>January 15, 2024:</strong> Updated terms
                            related to course content and certification.
                          </li>
                          <li>
                            <strong>October 10, 2023:</strong> Added definitions
                            section for clarity.
                          </li>
                          <li>
                            <strong>June 5, 2023:</strong> Updated user account
