                  ...
                  >
                    ...
                    <div className="prose max-w-none">
                      <TabsContent value="statement">
                        ...
                        <p>
                          EduPortal is committed to ensuring digital
                          accessibility for people with disabilities. We are
                          continually improving the user experience for
                        ...
                        <p>
                          ...
                          regardless of disability, location, or the technology
                          used. Our goal is to provide an accessible and
                          inclusive experience for all users, including those
                        ...
                        <p>
                          We strive to ensure that our website and learning
                          platform conform to the Web Content Accessibility
                          Guidelines (WCAG) 2.1 Level AA. These guidelines
                          explain how to make web content more accessible for
                          people with disabilities.
                        </p>

                        <h3>Scope of Statement</h3>
                        <p>
                          This accessibility statement applies to the EduPortal
                          website at <Link href="/">https://eduportal.com</Link>{" "}
                          and all its subdomains, including our learning
                          management system, course catalog, and student
                          dashboard.
                        </p>
                        ...
                        <p>
                          ...
                          EduPortal. Please let us know if you encounter
                      ...
                      <TabsContent value="conformance">
                        ...
                        <p>
                          EduPortal is partially conformant with WCAG 2.1 level
                          AA. Partially conformant means that some parts of the
                        ...
                        <p>
                          The EduPortal website is designed to be compatible
                          with the following assistive technologies:
                        </p>
                        <ul>
                          <li>
                            Screen readers (including JAWS, NVDA, VoiceOver, and
                            TalkBack)
                          </li>
                        ...
                        <p>
                          The website is designed to be compatible with the
                          following browsers:
                        </p>
                        <ul>
                          <li>
                            The latest versions of Chrome, Firefox, Safari, and
                            Edge
                          </li>
                        ...
                        <p>
                          Accessibility of EduPortal relies on the following
                          technologies to work with the particular combination
                        ...
                        <p>
                          EduPortal assesses the accessibility of our website
                      ...
                      <TabsContent value="features">
                        ...
                        <p>
                          EduPortal includes the following accessibility
                          features to help users with disabilities access and
                          use our content:
                        </p>
                        ...
                        <ul>
                          <li>
                            Consistent navigation structure throughout the
                            website
                          </li>
                          <li>
                            Skip to main content link at the beginning of each
                            page
                          </li>
                          <li>
                            Breadcrumb navigation to help users understand their
                            location
                          </li>
                          <li>
                            Descriptive page titles that clearly indicate the
                        ...
                        <ul>
                          ...
                          <li>
                            Sufficient color contrast between text and
                            background
                          </li>
                          <li>
                          ...
                          <li>
                            No content that flashes more than three times per
                            second
                          </li>
                          <li>
                            Clear visual focus indicators for keyboard
                            navigation
                          </li>
                        </ul>
                        ...
                        <ul>
                          ...
                          <li>
                            Descriptive link text that makes sense out of
                            context
                          </li>
                        ...
                        <ul>
                          ...
                          <li>
                            Error messages are clearly identified and provide
                            suggestions for correction
                          </li>
                          <li>Required fields are clearly indicated</li>
                          <li>Sufficient time to complete forms</li>
                          <li>
                            No automatic form submission when selecting an
                        ...
                        <ul>
                          ...
                          <li>
                            Interactive elements that can be operated with
                            keyboard alone
                          </li>
                          <li>
                            Alternative formats for course materials when
                            possible
                          </li>
                          <li>Extended time options for timed assessments</li>
                          <li>
                            Text-to-speech functionality for course content
                          </li>
                        </ul>
                      </TabsContent>
                      ...
                      <TabsContent value="contact">
                        ...
                        <p>
                          ...
                          EduPortal, we want to hear about it. Your feedback
                          helps us improve the accessibility of our platform for
                          everyone.
                        </p>

                        <h3>How to Report Accessibility Issues</h3>
                        <p>
                          You can report accessibility issues in the following
                          ways:
                        </p>
                        <ul>
                          <li>Email: accessibility@eduportal.com</li>
                        ...
                        <ul>
                          ...
                          <li>
                            The device, browser, and assistive technology you
                            were using
                          </li>
                        ...
                        <p>
                          Our accessibility team is available to provide support
                          and assistance to users with disabilities. We can help
                          with:
                        </p>
                        <ul>
                        ...
                        <p>
                          ...
                          business days, and to resolve issues within 10
                          business days when possible. If you are dissatisfied
                          with our response to your feedback, you may contact us
                          to file a formal complaint.
                        </p>
                        <p>
                          You also have the right to file a complaint with the
                          U.S. Department of Justice, Civil Rights Division,
                          Disability Rights Section, or the U.S. Department of
                        ...
                        <p>
                          ...
                          accessibility of our website and learning platform. We
                          regularly review our accessibility efforts and work to
                          address known issues.
                        </p>
                        <p>
                          Thank you for your support and feedback as we work to
                          make EduPortal accessible to all users.
                        </p>
                      </TabsContent>
                    </div>
                  </Tabs>
