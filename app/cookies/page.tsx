...
import { ChevronRight, FileText, Shield, Cookie, HelpCircle, Printer, Download } from "lucide-react"
            ...
            <div className="lg:w-3/4">
              <Card>
                <CardContent className="p-6 md:p-8">
                  <Tabs defaultValue="what" value={activeTab} onValueChange={setActiveTab} className="mb-8">
                    ...
                    <div className="prose max-w-none">
                      <TabsContent value="what">
                        ...
                        <p>
                          This Cookie Policy explains how EduPortal ("we", "us", or "our") uses cookies and similar
                          technologies to recognize you when you visit our website at{" "}
                          <Link href="/">https://eduportal.com</Link> ("Website"). It explains what these technologies
                        ...
                        <p>
                          Cookies set by the website owner (in this case, EduPortal) are called "first-party cookies".
                          Cookies set by parties other than the website owner are called "third-party cookies".
                          Third-party cookies enable third-party features or functionality to be provided on or through
                          the website (e.g., advertising, interactive content, and analytics). The parties that set
                        ...
                        <p>
                          ...
                          of our users to enhance the experience on our Website. Third parties serve cookies through our
                          Website for advertising, analytics, and other purposes. This is described in more detail
                          below.
                        </p>

                        <h3>How Long Do Cookies Last?</h3>
                        <p>
                          The length of time a cookie will remain on your computer or mobile device depends on whether
                          it is a "persistent" or "session" cookie. Session cookies will remain on your device until you
                          stop browsing. Persistent cookies remain on your computer or mobile device until they expire
                          or are deleted.
                        </p>
                      </TabsContent>
                      ...
                      <TabsContent value="types">
                        ...
                        <Table>
                          ...
                          <TableBody>
                            <TableRow>
                              ...
                              <TableCell>Preserves user session state across page requests</TableCell>
                        ...
                        <Table>
                          ...
                          <TableBody>
                            <TableRow>
                              ...
                              <TableCell>EduPortal</TableCell>
                              <TableCell>Remembers user language preference</TableCell>
                              <TableCell>1 year</TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>ui_theme</TableCell>
                              <TableCell>EduPortal</TableCell>
                              <TableCell>Remembers user interface theme preference</TableCell>
                              <TableCell>1 year</TableCell>
                            </TableRow>
                            <TableRow>
                              <TableCell>recently_viewed</TableCell>
                              <TableCell>EduPortal</TableCell>
                              <TableCell>Tracks recently viewed courses</TableCell>
                              <TableCell>30 days</TableCell>
                            </TableRow>
                          </TableBody>
                        </Table>
                        ...
                        <Table>
                          ...
                          <TableBody>
                            <TableRow>
                              ...
                              <TableCell>Registers a unique ID used to generate statistical data</TableCell>
                        ...
                        <p>
                          ...
                          properly displayed for advertisers, and in some cases selecting advertisements that are based
                          on your interests.
                        </p>
                        ...
                        <Table>
                          ...
                          <TableBody>
                            ...
                            <TableRow>
                              ...
                              <TableCell>Google</TableCell>
                              <TableCell>Used by Google DoubleClick to register user actions</TableCell>
                              <TableCell>1 year</TableCell>
                            </TableRow>
                            <TableRow>
                      ...
                      <TabsContent value="manage">
                        ...
                        <p>
                          ...
                          preferences by clicking on the "Manage Cookies" button at the bottom of our website.
                        </p>
                        ...
                        <p>
                          ...
                          areas of our website may be restricted. As the means by which you can refuse cookies through
                        ...
                        <p>
                          Most advertising networks offer you a way to opt out of Interest Based Advertising. If you
                        ...
                        <h3>Do Not Track</h3>
                        <p>
                          Some Internet browsers - like Internet Explorer, Firefox, and Safari - include the ability to
                          transmit "Do Not Track" or "DNT" signals. Since uniform standards for "DNT" signals have not
                          been adopted, our Website does not currently process or respond to "DNT" signals.
                        </p>
                        ...
                        <p>
                          ...
                          prior to your disabled preference being set, however, we will stop using the disabled cookie
                          to collect any further information.
                        </p>

                        <h3>Third-Party Opt-Out Options</h3>
                        <p>
                          For more information on how our third-party providers use cookies and how to opt-out, please
                      ...
                      <TabsContent value="changes">
                        ...
                        <h3>Change Log</h3>
                        <p>Below is a summary of significant changes to our Cookie Policy:</p>
                        <ul>
                          <li>
                            <strong>January 15, 2024:</strong> Updated list of cookies used and their purposes.
                          </li>
                          <li>
                            <strong>October 10, 2023:</strong> Added information about third-party opt-out options.
                          </li>
                          <li>
                            <strong>June 5, 2023:</strong> Updated information about browser controls.
                          </li>
                          <li>
                            <strong>March 20, 2023:</strong> Initial publication of Cookie Policy.
                          </li>
                        </ul>
