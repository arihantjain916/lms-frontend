                ...
                <CardContent className="p-6 md:p-8">
                  ...
                  <div className="prose max-w-none">
                    <TabsContent value="collection">
                      ...
                      <p>
                        At EduPortal, we take your privacy seriously. This Privacy Policy explains how we collect, use,
                        disclose, and safeguard your information when you visit our website or use our educational
                      ...
                      <ul>
                        ...
                        <li>
                          <strong>Educational Information:</strong> Course enrollments, progress, completion status,
                          certificates earned, and assessment results.
                        </li>
                        <li>
                          <strong>Payment Information:</strong> Credit card details, billing address, and other
                          financial information necessary for processing payments.
                        </li>
                        <li>
                          <strong>Communications:</strong> Feedback, questions, comments, and other information you
                          provide when contacting us or participating in surveys.
                        </li>
                      </ul>

                      <h3>Automatically Collected Information</h3>
                      <p>
                        In addition to the information you voluntarily provide, we may automatically collect certain
                        information about your device and how you interact with our website. This information may
                        include:
                      </p>
                      <ul>
                        <li>
                        ...
                        <li>
                          ...
                          beacons, and similar technologies. For more information, please see our{" "}
                      ...
                      <ul>
                        <li>
                          <strong>Social Media:</strong> If you choose to link your social media accounts to our
                          services, we may receive information from those accounts.
                        </li>
                        <li>
                          <strong>Partners:</strong> Educational institutions, employers, or other partners with whom we
                          collaborate may share information about you with your consent.
                        </li>
                        <li>
                          <strong>Public Sources:</strong> Publicly available information, such as social media profiles
                    ...
                    <TabsContent value="use">
                      ...
                      <p>
                        ...
                        improving our services. These purposes include:
                      </p>
                      ...
                      <ul>
                        ...
                        <li>Personalizing your learning experience based on your preferences and behavior</li>
                        <li>Developing new features, products, and services</li>
                        <li>Conducting research and analysis to enhance educational outcomes</li>
                        <li>Testing and troubleshooting new products and features</li>
                      </ul>

                      <h3>Marketing and Communication</h3>
                      <ul>
                        <li>Sending promotional communications about new courses, special offers, and events</li>
                        <li>Providing updates about your courses or account</li>
                        <li>Conducting surveys and collecting feedback</li>
                        <li>Delivering targeted advertisements based on your interests and preferences</li>
                      </ul>
                      ...
                      <ul>
                        ...
                        <li>Protecting against, investigating, and preventing potentially illegal activities</li>
                      ...
                      <ul>
                        ...
                        <li>
                          <strong>Contract:</strong> Processing is necessary to fulfill our contractual obligations to
                          you.
                        </li>
                        <li>
                        ...
                        <li>
                          <strong>Legal Obligation:</strong> Processing is necessary to comply with applicable laws and
                          regulations.
                        </li>
                      </ul>
                    </TabsContent>
                    ...
                    <TabsContent value="sharing">
                      ...
                      <p>
                        We may share your information with third parties in certain circumstances. We do not sell your
                      ...
                      <ul>
                        <li>
                          <strong>Service Providers:</strong> Companies that provide services on our behalf, such as
                          payment processing, data analysis, email delivery, hosting services, and customer service.
                        </li>
                        <li>
                          <strong>Educational Partners:</strong> Educational institutions, instructors, and other
                          partners with whom we collaborate to provide educational services.
                        </li>
                        <li>
                          <strong>Business Partners:</strong> Companies with whom we partner to offer joint promotions
                          or services.
                        </li>
                        <li>
                          <strong>Advertising Partners:</strong> Third parties that help us deliver relevant
                          advertisements and marketing communications.
                        </li>
                        <li>
                          <strong>Analytics Providers:</strong> Companies that help us analyze how our services are
                          used.
                        </li>
                        <li>
                          <strong>Social Media Platforms:</strong> Social media platforms when you interact with our
                          content on those platforms or use social media login features.
                        </li>
                      </ul>
                      ...
                      <ul>
                        <li>
                          <strong>With Your Consent:</strong> We may share your information when you have given us
                          permission to do so.
                        </li>
                        <li>
                          <strong>For Legal Reasons:</strong> We may share your information to comply with applicable
                          laws and regulations, to respond to a subpoena, search warrant, or other lawful request, or to
                          protect our rights.
                        </li>
                        <li>
                          <strong>Business Transfers:</strong> In connection with a merger, acquisition, reorganization,
                          sale of assets, or bankruptcy, your information may be transferred as a business asset.
                        </li>
                        <li>
                          <strong>Aggregated or De-identified Information:</strong> We may share aggregated or
                      ...
                      <p>
                        ...
                        note that we transfer the information, including personal information, to the United States and
                        process it there. Your consent to this Privacy Policy followed by your submission of such
                        information represents your agreement to that transfer.
                      </p>
                      <p>
                        We will take all steps reasonably necessary to ensure that your data is treated securely and in
                        accordance with this Privacy Policy and no transfer of your personal information will take place
                    ...
                    <TabsContent value="rights">
                      ...
                      <p>
                        ...
                        Upon request, we will provide you with a copy of your personal information in a structured,
                      ...
                      <p>
                        ...
                        about you. You can update much of your personal information directly through your account
                        settings.
                      </p>
                      ...
                      <p>
                        ...
                        Please note that we may need to retain certain information for record-keeping purposes, to
                        complete transactions, or to comply with our legal obligations.
                      </p>

                      <h3>Restriction and Objection</h3>
                      <p>
                        You have the right to request that we restrict the processing of your personal information in
                        certain circumstances. You also have the right to object to the processing of your personal
                        information in certain circumstances.
                      </p>

                      <h3>Withdraw Consent</h3>
                      <p>
                        If we are processing your personal information based on your consent, you have the right to
                        withdraw that consent at any time. This will not affect the lawfulness of processing based on
                        consent before its withdrawal.
                      </p>

                      <h3>Do Not Track</h3>
                      <p>
                        We do not currently respond to "Do Not Track" signals or similar mechanisms. However, you can
                        configure your browser to send "Do Not Track" signals to websites you visit, and some browsers
                        may be configured to send these signals by default.
                      </p>

                      <h3>How to Exercise Your Rights</h3>
                      <p>
                        To exercise your rights, please contact us using the contact information provided at the end of
                        this Privacy Policy. We may need to verify your identity before responding to your request. We
                        will respond to your request within the timeframe required by applicable law.
                      </p>
                      <p>
                        In some regions, you may have the right to file a complaint with your local data protection
                      ...
                      <p>
                        ...
                        Act (CCPA) and the California Privacy Rights Act (CPRA). For more information about your
                        California privacy rights, please see our California Privacy Notice.
                      </p>

                      <h3>European Privacy Rights</h3>
                      <p>
                        If you are located in the European Economic Area (EEA), United Kingdom, or Switzerland, you have
                        rights under the General Data Protection Regulation (GDPR) and similar laws. For more
                        information about your European privacy rights, please see our European Privacy Notice.
                      </p>
                    </TabsContent>
                  </div>
                     </Tabs>
